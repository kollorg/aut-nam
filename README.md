<div align="center">
  ...
  <div style="display: flex;justify-content:center;">
    <img src="https://img.shields.io/github/package-json/v/kollorg/aut-nam"></img>
    <img src="https://circleci.com/gh/kollorg/aut-nam.svg?style=svg"></img>
    <img src="https://img.shields.io/badge/License-MIT-blue.svg"/> 
    <img src="https://img.shields.io/npm/dt/@kollorg/aut-nam.svg"></img>
  </div>
</div>

`@kollorg/aut-nam` is an [Interactive Brokers](http://interactivebrokers.com/) TWS (or IB Gateway) Typescript API client library for [Node.js](http://nodejs.org/). It is a direct port of Interactive Brokers' Java Client Version 10.25 ("latest") from Sept 7 2023.
...
## Installation
    ...
    $ npm install @kollorg/aut-nam

or

    $ yarn add @kollorg/aut-nam
...
import { IBApi, EventName, ErrorCode, Contract } from "@kollorg/aut-nam";
...
If you want to contribute, read the [Developer Guide](https://github.com/kollorg/aut-nam/wiki/Developer-Guide) and start coding.
